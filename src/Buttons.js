    ...
    const buttonNewQuote = this.props.buttonNewQuote;
      return (      
        ...
        <div class="social-button-container">
          <button class="button button-social" style={buttonColor}>
        ...
        <button class="button button-quote js-button-quote" style={buttonColor} onClick={buttonNewQuote}>New Quote</button>
      </div>
      );
